...
#include "gtest/gtest.h" // This is required for all unit test code


TEST ( ForcastDisplayUnitTests, Examples  ) {
   ...
   ASSERT_TRUE( thatAllAveragesAreThirty ); // average should be thirty for all members
